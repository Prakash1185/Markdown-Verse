...
const Footer = () => {
    return (
        <footer className="border-t border-dashed border-foreground/10 px-4 sm:px-6 lg:px-8 py-6">
            <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-muted-foreground">
                ...
                <p className="flex items-center gap-1.5">
                    ...
                    <span className="text-foreground font-medium"> <Link href="https://www.linkedin.com/in/prakash-kumar-b26183330/" target="_blank">Prakash</Link> </span>
                </p>
            </div>
        </footer>
    );
