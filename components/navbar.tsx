  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 w-full border-b border-foreground/10 bg-background/80 backdrop-blur-md">
      <div className="max-w-7xl mx-auto flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
        ...
        <Link href="/" className="text-xl font-semibold tracking-tight space-x-2">
          <span className="bg-primary text-primary-foreground px-2 py-1">M</span>
          <span className="text-primary">Markdown</span>Verse
        </Link>

        {/* Desktop Nav */}
        <div className="hidden sm:flex items-center gap-6">
          <Link href="/learn" className="text-sm font-medium text-muted-foreground hover:text-primary transition-colors">
            Learning Path
          </Link>
          <Link href="/playground" className="text-sm font-medium text-muted-foreground hover:text-primary transition-colors">
            Playground
          </Link>
        ...
        <div className="sm:hidden flex items-center gap-3">
          ...
          <Sheet>
            ...
            <SheetContent side="right" className="w-72 bg-background border-l border-foreground/10 px-5 pt-16">
              <nav className="flex flex-col gap-6">
                <Link href="/" className="text-lg font-medium border-b border-foreground/5 pb-2">Home</Link>
                <Link href="/learn" className="text-lg font-medium border-b border-foreground/5 pb-2">Learning Path</Link>
                <Link href="/playground" className="text-lg font-medium border-b border-foreground/5 pb-2">Playground</Link>
                <Link href="/learn" className="mt-4 bg-primary text-primary-foreground px-6 py-3 text-center font-medium rounded-md">
                  Start Learning
                </Link>
              </nav>
            </SheetContent>
